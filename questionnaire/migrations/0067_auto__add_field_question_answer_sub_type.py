...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.answer_sub_type'
        db.add_column(u'questionnaire_question', 'answer_sub_type',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.answer_sub_type'
        db.delete_column(u'questionnaire_question', 'answer_sub_type')
