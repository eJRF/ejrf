...
question7 = Question.objects.create(text='Are any routine doses of vaccine given to children at school?', UID='C00007',
...
question8 = Question.objects.create(text='Vaccine procurement', UID='C00008', answer_type='MultiChoice',
                                    export_label='Which activities is the EPI Program responsible for (and not the school staff per se) Vaccine procurement')
...
question9 = Question.objects.create(text='Vaccinators', UID='C00009', answer_type='MultiChoice',
                                    export_label=' Which activities is the EPI Program responsible for (and not the school staff per se) Vaccinators')
...
question10 = Question.objects.create(text='Supervision', UID='C00010', answer_type='MultiChoice',
                                     export_label='Which activities is the EPI Program responsible for (and not the school staff per se) Supervision')
...
question11 = Question.objects.create(text='Planing', UID='C00011', answer_type='MultiChoice',
                                     export_label='Which activities is the EPI Program responsible for (and not the school staff per se) Planning')
...
question12 = Question.objects.create(text='Is this part of a comprehensive school health program that delivers other '
                                          'health intervention also?',
                                     export_label='Is this part of a comprehensive school health program that delivers other health interventions also?',
                                     UID='C00012', answer_type='MultiChoice')
...
question13 = Question.objects.create(text='Which interventions are given in the school health program?', UID='C00013',
                                     answer_type='Text',
                                     export_label='If "yes", which interventions are given in the school health program?')
...
sub_section_4 = SubSection.objects.create(order=2, section=section_2, title="Routine Immunization given at school "
                                                                            "(please complete one row  for each grade level or age and vaccine)",
                                          description="""
...
question20 = Question.objects.create(text='Number of doses administered at school', UID='C00020', answer_type='Number',
                                     export_label=' No. doses administered at school',
                                     instructions="""
