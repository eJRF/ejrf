...
urlpatterns = patterns('',
    ...
    url(r'^questionnaire/subsection/(?P<subsection_id>\d+)/skiprules/$', SkipQuestionView.as_view(), name="get_skip_rules"),
    ...
    url(r'^subsection/(?P<subsection_id>\d+)/grid/(?P<questionGroup_id>\d+)/delete/$', DeleteGrid.as_view(), name="delete_grid_page"),
