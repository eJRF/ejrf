...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SkipQuestion.root_question'
        db.add_column(u'questionnaire_skipquestion', 'root_question',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='root_question', to=orm['questionnaire.Question']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SkipQuestion.root_question'
        db.delete_column(u'questionnaire_skipquestion', 'root_question_id')
