...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SkipQuestion.subsection'
        db.add_column(u'questionnaire_skipquestion', 'subsection',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='subsection', to=orm['questionnaire.SubSection']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SkipQuestion.subsection'
        db.delete_column(u'questionnaire_skipquestion', 'subsection_id')
