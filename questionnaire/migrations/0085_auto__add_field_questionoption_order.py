...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionOption.order'
        db.add_column(u'questionnaire_questionoption', 'order',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionOption.order'
        db.delete_column(u'questionnaire_questionoption', 'order')
