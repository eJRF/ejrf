...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TextAnswer.response'
        db.alter_column(u'questionnaire_textanswer', 'response', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'TextAnswer.response'
        db.alter_column(u'questionnaire_textanswer', 'response', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
