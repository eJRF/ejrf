...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubSection.is_core'
        db.add_column(u'questionnaire_subsection', 'is_core',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Section.is_core'
        db.add_column(u'questionnaire_section', 'is_core',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubSection.is_core'
        db.delete_column(u'questionnaire_subsection', 'is_core')

        # Deleting field 'Section.is_core'
        db.delete_column(u'questionnaire_section', 'is_core')
