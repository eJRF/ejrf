...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SkipRule.region'
        db.add_column(u'questionnaire_skiprule', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='skip_rules', null=True, to=orm['questionnaire.Region']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SkipRule.region'
        db.delete_column(u'questionnaire_skiprule', 'region_id')
