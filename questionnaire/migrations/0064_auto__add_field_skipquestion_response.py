...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SkipQuestion.response'
        db.add_column(u'questionnaire_skipquestion', 'response',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='response_option', to=orm['questionnaire.QuestionOption']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SkipQuestion.response'
        db.delete_column(u'questionnaire_skipquestion', 'response_id')
