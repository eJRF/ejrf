...
from questionnaire.views.skip_question import SkipRuleView
...
from questionnaire.views.questionnaires import Entry, SubmitQuestionnaire, DuplicateQuestionnaire, \
    FinalizeQuestionnaire, UnfinalizeQuestionnaire, PublishQuestionnaire, ApproveQuestionnaire, DeleteAnswerRow, Archive, Delete
...
urlpatterns = patterns('',
                       ...
                       url(r'^accounts/login/$', 'django.contrib.auth.views.login',
                           {'template_name': 'users/login.html'}, name="login_page"),
                       ...
                       url(r'^extract/country/(?P<country_id>\d+)/version/(?P<version_number>\d+)/$',
                           SpecificExportView.as_view(), name="specific_export_page"),
                       ...
                       url(r'^locations/organization/(?P<organization_id>\d+)/region/$',
                           RegionsForOrganization.as_view()),
                       ...
                       url(
                           r'^questionnaire/entry/(?P<questionnaire_id>\d+)/section/(?P<section_id>\d+)/delete/(?P<group_id>\d+)/$',
                           DeleteAnswerRow.as_view()),
                       url(r'^questionnaire/entry/(?P<questionnaire_id>\d+)/section/new/$', NewSection.as_view(),
                           name="new_section_page"),
                       url(
                       ...
                       url(r'^questionnaire/(?P<questionnaire_id>\d+)/archive/$', Archive.as_view(),
                           name="archive_questionnaire_page"),
                       url(r'^questionnaire/(?P<questionnaire_id>\d+)/delete/$', Delete.as_view(),
                           name="delete_questionnaire_page"),
                       ...
                       url(r'^questionnaire/(?P<questionnaire_id>\d+)/publish/$', PublishQuestionnaire.as_view(),
                           name="publish_questionnaire_page"),
                       url(r'^questionnaire/(?P<questionnaire_id>\d+)/preview/$', PreviewQuestionnaire.as_view(),
                           name="preview_specific_questionnaire"),
                       ...
                       url(r'^questionnaire/document/(?P<document_id>\d+)/delete/$', DeleteDocument.as_view(),
                           name='delete_document'),
                       url(r'^questionnaire/entry/duplicate/$', DuplicateQuestionnaire.as_view(),
                           name='duplicate_questionnaire_page'),
                       ...
                       url(r'^questions/(?P<question_id>\d+)/edit/$', EditQuestion.as_view(),
                           name='edit_question_page'),
                       url(r'^questions/(?P<question_id>\d+)/delete/$', DeleteQuestion.as_view(),
                           name='delete_question_page'),
                       url(r'^submit/(?P<questionnaire_id>\d+)$', SubmitQuestionnaire.as_view(),
                           name="submit_questionnaire_page"),
                       url(r'^subsection/(?P<subsection_id>\d+)/grid/new/$', CreateGrid.as_view(),
                           name="create_grid_page"),
                       url(r'^subsection/(?P<subsection_id>\d+)/grid/(?P<questionGroup_id>\d+)/delete/$',
                       ...
                       url(r'^section/(?P<section_id>\d+)/delete/', DeleteSection.as_view(),
                           name="delete_section_page"),
                       url(r'^subsection/(?P<subsection_id>\d+)/edit/$', EditSubSection.as_view(),
                           name="edit_subsection_page"),
                       url(r'^subsection/(?P<subsection_id>\d+)/delete/$', DeleteSubSection.as_view(),
                           name="delete_subsection_page"),
