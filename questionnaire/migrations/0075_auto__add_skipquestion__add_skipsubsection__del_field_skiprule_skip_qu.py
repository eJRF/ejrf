...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SkipRule.skip_question'
        db.delete_column(u'questionnaire_skiprule', 'skip_question_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SkipRule.skip_question'
        db.add_column(u'questionnaire_skiprule', 'skip_question',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='skip_rules', null=True, to=orm['questionnaire.Question'], blank=True),
                      keep_default=False)
