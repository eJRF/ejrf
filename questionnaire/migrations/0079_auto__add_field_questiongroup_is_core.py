...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionGroup.is_core'
        db.add_column(u'questionnaire_questiongroup', 'is_core',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionGroup.is_core'
        db.delete_column(u'questionnaire_questiongroup', 'is_core')
