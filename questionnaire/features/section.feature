Feature: Section feature
  ...
  Scenario: Update Section in Core Questionnaire
    ...
    And I should see the current position of the section
    When I update the section details
    And I change the position of the section
    ...
    When I choose to update that section again
    Then I should see its new position
